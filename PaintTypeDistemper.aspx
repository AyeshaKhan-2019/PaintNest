<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaintTypeDistemper.aspx.cs" Inherits="Paint_Nest_WebApp.PaintTypeDistemper" %>
...
<body>
    ...
    <br />
    <br />
    <!-- PaintTypeEnamel start -->

    <div class="featured-product product">
        <div class="container-fluid">
            <div class="section-header">
                <h1>PAINT TYPE: DISTEMPER PAINT</h1>
                <p>Enamel paint can be used on copper, metal surfaces, glass, wood, plastic and even on walls. The paint is resistant to moisture and its perfect for surfaces that need to be washed multiple times.</p>
            </div>
            <br />
            <div class="section-header">
                <h2>VENDORS</h2>
    ...
    <script type="text/javascript">
        $(function () {
            PageMethods.GetDistemperPaints(function (data) {
                debugger;
                var htmlTemp = '';
                $.each(data, (k, v) => {
                    htmlTemp += `<div class="column">
    <div class="card">
  <img src="${v.paint_image}" alt="${v.paint_name}" style="width:100%">
        <hr />
  <h1>${v.paint_name}</h1>
        <hr />
  <p class="title">Price: Rs.800-Rs.11,000</p>
  <p>Size:</p>
  <div style="margin: 10px 0;">
     <div class="btn-group btn-group-sm">
      <button type="button" class="pt btn">Quarter - 0.91 Litre</button>
     <button type="button" class="pt btn">Gallon - 3.64 Litre</button>
     <button type="button" class="pt btn">Drum - 14.56</button>
  </div>
      </div>
        <br />
  <p><a href='ProductDetail-RainbowEnamel.aspx?ID=${v.paintID}'>View Details</a></p>
</div>
  </div>`;
                });
                $('.paints-data').append(htmlTemp);
                return false;
            })
        });
    </script>
            <div class="pt">
                <div class="row paints-data">
                </div>
            </div>
                </form>
