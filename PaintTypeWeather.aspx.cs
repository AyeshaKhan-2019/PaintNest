...
{
    public partial class PaintTypeWeather : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static List<PaintViewModel> GetWeatherPaints()
        {
            List<Paint> paints = DbContext.Paints.Where(i => i.paintCategoryID == "EXWEA").ToList();
