...
{
    public partial class PaintTypeEnamel : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static List<PaintViewModel> GetEnamelPaints()
        {
            List<Paint> paints = DbContext.Paints.Where(i => i.paintCategoryID == "INENA").ToList();
