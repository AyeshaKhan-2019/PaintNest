<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyDashboard.aspx.cs" Inherits="Paint_Nest_WebApp.CompanyDashboard" %>
...
<div class="col-8 col-sm-10">
        ...
        <div class="row" style="padding-left:-7px;">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="OrderManagement.aspx" style="color:black;">Order Received</a></span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="OrderManagement.aspx" style="color:black;">Orders in Progress</a></span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-4">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="OrderManagement.aspx" style="color:black;">Orders Completed</a></span>
 ...
 <div id="Paris" class="w3-container city" style="display:none">
   ...
   <br/>
    ...
    <section class="content">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-12">
            <div class="info-box info-outline-purple">
              ...
              <div class="info-box-content">
                <span class="info-box-text" style="color: #6f42c1;"><b>COMPANY INFORMATION</b></span>
               
                <span class="progress-description" style="padding-left:2%;">
                   <span id="name">Name: </span>        <asp:Label ID="LabelProfileName" runat="server" Text=""></asp:Label><br />
                  <span id="email">Email: </span>       <asp:Label ID="LabelProfileEmail" runat="server" Text=""></asp:Label><br />
      ...
      <form runat="server" id="Form" style="top:20%; left:10%; border:none; right:15px;">
         <!--form header-->
  ...
  <div id="Tokyo" class="w3-container city" style="display:none">
    ...
    <!--Catalog Table-->
      ...
      <div class="card">
        <div class="card-header">
            <!-- Add PRODUCT-->
           <a href="ProductManagement.aspx" class="btn bg-purple" style="color:white;">
               <i class="fas fa-folder-plus"></i>&nbsp Add New Product
           </a>
                  ...
                  <tr>
                      ...
                      <td>
                       ...
                       <div class="ïnfo-box">
                           <ul class="list-inline">
                               <li class="list-inline-item"><span class="info-box"  style="background-color:#e6bccf; min-height:30px; display:flex; width:30px;" data-toggle="tooltip" data-placement="top" title="Blossom Pink &nbsp &#35 12343"></span></li>
                               <li class="list-inline-item"><span class="info-box"  style="background-color:#273f5d; min-height:30px; display:flex; width:30px;" data-toggle="tooltip" data-placement="top" title="Indigo &nbsp &#35 12343"></span></li>
                               <li class="list-inline-item"><span class="info-box"  style="background-color:#d0e8ca; min-height:30px; display:flex; width:30px;" data-toggle="tooltip" data-placement="top" title="Glacier Blue &nbsp &#35 12343"></span></li>
                               <li class="list-inline-item"><span class="info-box"  style="background-color:#c3c7ca; min-height:30px; display:flex; width:30px;" data-toggle="tooltip" data-placement="top" title="Grey Blue &nbsp &#35 12343"></span></li>
                           </ul>
                       </div>
                      ...
                      <td>
                          <ul style="list-style-type:none;">
                              <li><em>Quater:</em> Rs.&nbsp<span>111</span></li>
                              <li><em>Gallon:</em> Rs.&nbsp<span>111</span></li>
                              <li><em>Drum:</em> Rs.&nbsp<span>111</span></li>
                          </ul>
                      </td>
                      <td class="project-actions text-right">
                        <ul style="list-style-type:none;">
                          <li style="padding:3px;"><a class="btn btn-info btn-sm" href="#" style="padding-left:12px; padding-right:18px;"><i class="fas fa-pencil-alt"></i>&nbsp Edit</a></li>
                          <li style="padding:3px;"><a class="btn btn-danger btn-sm" href="#"><i class="fas fa-trash"></i>&nbsp Delete</a></li>
                        </ul>
                     </td>
                  </tr>
               </tbody>
 ...
 <!-- Product Block-->
        ...
        <!-- Company Dasboard end -->
     <span class="col-12" style="background-color: #e2e5ef;"><br /><br /></span>
