<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="Paint_Nest_WebApp.ContactUs" %>
                        ...
                        <div class="navbar-nav ml-auto">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="LoginMain.aspx" id="MyAcc" class="dropdown-item" runat="server">My Account</a>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <div class="card">
        <div class="card-body row">
          ...
          <div class="col-7" >
            ...
            <span onclick="location.href='ContactUs.aspx'" class="w3-button w3-large w3-display-right">&times;</span> 
