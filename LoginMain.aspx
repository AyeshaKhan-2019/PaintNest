<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginMain.aspx.cs" Inherits="Paint_Nest_WebApp.LoginMain" %>
...
<body>
                        ...
                        <div class="navbar-nav ml-auto">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="LoginMain.aspx" class="dropdown-item active">Login</a>
    ...
    <div class="row" style="align-content:center;">
        ...
        <div class="col-md-4">
            <asp:Button ID="Button1" runat="server" Text="Login as Paint Customer" PostBackUrl="~/Login.aspx" class="register1btn" />
            </div>
        <div class="col-md-4">
            <asp:Button ID="Button2" runat="server" Text="Login as Paint Company" PostBackUrl="~/LoginCompany.aspx" class="register1btn" />
            </div>
