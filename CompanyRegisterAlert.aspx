<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyRegisterAlert.aspx.cs" Inherits="Paint_Nest_WebApp.CompanyRegisterAlert" %>
...
<body>
  ...
  <h2 style="color: #663399; text-align:center; font-family:Arial">Your Company Has Successfully Registered!</h2>
         
   <br/>  

   <form runat="server">

       <asp:Button ID="BtnRegAlert" runat="server" Text="Get Started" class="btnRegAlert RegAlertcenter" OnClientClick="BtnRegAlert_click" OnClick="BtnRegAlert_Click" />
