<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaintTypeWeather.aspx.cs" Inherits="Paint_Nest_WebApp.PaintTypeWeather" %>
...
<body>
    ...
    <div class="featured-product product">
        <div class="container-fluid">
            <div class="section-header">
                <h1>PAINT TYPE: WEATHER PAINT</h1>
    ...
    <script type="text/javascript">
        $(function () {
            PageMethods.GetWeatherPaints(function (data) {
                debugger;
                var htmlTemp = '';
                $.each(data, (k, v) => {
