<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaintTypeEmulsion.aspx.cs" Inherits="Paint_Nest_WebApp.PaintTypeEmulsion" %>
...
<body>
    ...
    <div class="featured-product product">
        <div class="container-fluid">
            <div class="section-header">
                <h1>PAINT TYPE: EMULSION PAINT</h1>
    ...
    <script type="text/javascript">
        $(function () {
            PageMethods.GetEmulsionPaints(function (data) {
                debugger;
                var htmlTemp = '';
                $.each(data, (k, v) => {
