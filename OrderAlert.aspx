<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderAlert.aspx.cs" Inherits="Paint_Nest_WebApp.OrderAlert" %>
...
<body>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                   <a href="Login.aspx" class="dropdown-item">
                                    ...
                                    <a href="CustomerDasboard.aspx" class="dropdown-item">My Account</a>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <h2 style="color: #663399; text-align:center; font-family:Arial">Your order has been received!</h2><br />
           <p style="text-align:center;">
      Thank you for shopping with us.</p>
   <br/>  

   <form runat="server">
       <asp:Button ID="BtnContShop" runat="server" Text="Continue Shopping" class="btnRegAlert RegAlertcenter" OnClick="BtnContShop_Click" />
      <br /><br />
