...
{
    public partial class PaintTypeDistemper : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static List<PaintViewModel> GetDistemperPaints()
        {
            List<Paint> paints = DbContext.Paints.Where(i => i.paintCategoryID == "INDIS").ToList();
