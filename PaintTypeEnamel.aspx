<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaintTypeEnamel.aspx.cs" Inherits="Paint_Nest_WebApp.PaintTypeEnamel" %>
...
<body>
    ...
    <script type="text/javascript">
        $(function () {
            PageMethods.GetEnamelPaints(function (data) {
                debugger;
                var htmlTemp = '';
                $.each(data, (k, v) => {
