<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaintTypeLatex.aspx.cs" Inherits="Paint_Nest_WebApp.PaintTypeLatex" %>
...
<body>
    ...
    <script type="text/javascript">
        $(function () {
            PageMethods.GetLatexPaints(function (data) {
                debugger;
                var htmlTemp = '';
                $.each(data, (k, v) => {
