<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderHistory.aspx.cs" Inherits="Paint_Nest_WebApp.OrderHistory" %>
...
<body>
        ...
        <div class="row" style="padding-left:-7px;">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="#View1" style="color:black;">Orders Placed</a></span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-4">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><a href="#View3" style="color:black;">Orders Delivered</a></span>
    ...
    <!-- TABLE: PLACED ORDERS -->
            <div id="View1" class="card card-info">
              <div class="card-header">
                <h3 class="card-title"><b>Orders Placed</b></h3>
    ...
    <!-- TABLE: DELIVERED ORDERS -->
            ...
            <!-- /.card end -->
         <!--TABLE-DELIVERED ORDER-->
       </div>         <!-- Table content end --> 

 <!-- Orderhistory content End -->
        <br /><br /><br />
 <!-- Footer Start -->
        <div class="footer">
            <div class="container-fluid">
