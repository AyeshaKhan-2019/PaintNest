<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register3.aspx.cs" Inherits="Paint_Nest_WebApp.Register3" %>
...
<body>
                        ...
                        <div class="navbar-nav ml-auto">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="LoginCompany.aspx" class="dropdown-item">Login</a>
                                    <a href="Register3.aspx" class="dropdown-item active">Register</a>
  ...
  <h2 style="color: #663399; text-align:center; font-family:Arial">Register as Paint Company</h2>
   

   <form runat="server">
       <asp:Label ID="LabelAlert" runat="server" Text="" ForeColor="Red"></asp:Label><br /><br/>
   Company Name<br/>
    <asp:TextBox ID="txtname" runat="server" style="border: #663399 1px solid; border-radius: 4px;width: 90%; padding: 3px;" type="text" name="Name" value="" class="text-input"></asp:TextBox>
      <br /> <asp:RequiredFieldValidator style="color:red;" ID="RequiredFieldValidator1" runat="server" ErrorMessage="***Name is Required***" ControlToValidate="txtname" ValidationGroup="Save"></asp:RequiredFieldValidator>
    <br/><br/>
    E-mail<br/>
   ...
   <br /> <asp:RequiredFieldValidator style="color:red;" ID="RequiredFieldValidator2" runat="server" ErrorMessage="***Email is Required***" ControlToValidate="txtemail" ValidationGroup="Save"></asp:RequiredFieldValidator>
       ...
       <br/><br/>
    Password<br/>
    <asp:TextBox ID="txtpassword" runat="server" style="border: #663399 1px solid; border-radius: 4px;width: 90%; padding: 3px;" type="text" name="Password" value="" class="text-input" TextMode="Password"></asp:TextBox>
    ...
    <br/><br/>
    Confirm Password<br/>
    <asp:TextBox ID="txtconfirmpass" runat="server" style="border: #663399 1px solid; border-radius: 4px;width: 90%; padding: 3px;" type="text" name="Confirm Password" value="" class="text-input" TextMode="Password"></asp:TextBox>
      <asp:CompareValidator style="color:red;" ID="CompareValidator1" runat="server" ErrorMessage="***Password do not match***" 
       ...
       <br /><br />
      <p style="text-align:center;">Already have an account? <a href= "LoginCompany.aspx" style="color:blue;"><b>Login here</b></a></p>
  </form> 
           </div>
<div class="col-md-3"></div>
           </div>
