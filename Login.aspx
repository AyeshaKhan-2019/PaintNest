<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Paint_Nest_WebApp.Login" %>
<!DOCTYPE html>
...
<body>
                        ...
                        <div class="navbar-nav ml-auto">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="Login.aspx" class="dropdown-item active">Login</a>
                                    <a href="Register2.aspx" class="dropdown-item ">Register</a>
  ...
  <h2 style="color: #663399; text-align:center; font-family:Arial">Login To Customer's Account</h2>
   ...
   <form runat="server">
    ...
    <br/><br/>
       ...
       <br /><br />
       <p style="text-align:center;">Do not have an account? Please <a href= "Register2.aspx" style="color:blue;"><b>Register here</b></a></p>
  </form> 
           </div>
<div class="col-md-3"></div>
           </div>
