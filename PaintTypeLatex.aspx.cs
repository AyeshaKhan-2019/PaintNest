...
{
    public partial class PaintTypeLatex : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static List<PaintViewModel> GetLatexPaints()
        {
            List<Paint> paints = DbContext.Paints.Where(i => i.paintCategoryID == "EXLAT").ToList();
